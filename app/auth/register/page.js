      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-bg relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="text-4xl font-bold mb-6 leading-tight">
            Join our scholarly<br />
            community today
          </h1>
          <p className="text-blue-100 text-lg mb-8 leading-relaxed max-w-md">
            Create an account to submit your research, track your publications, 
          ...
          <div className="space-y-4">
            {[
              { icon: "📤", text: "Submit manuscripts online" },
              { icon: "👁️", text: "Track your submission status" },
              { icon: "🌍", text: "Reach a global audience" },
            ].map((feature, i) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 mt-2">Join the Ubuntu Journal community</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Affiliation <span className="text-gray-400 font-normal">(optional)</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
